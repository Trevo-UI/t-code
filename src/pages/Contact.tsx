            ...
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
                    <div className="lg:col-span-2 lg:py-12">
                        ...
                        <div className="mt-8">
                            <a href="https://api.whatsapp.com/send?phone=5547988339861&text=Ol%C3%A1%2C%20gostaria%20de%20fazer%20um%20or%C3%A7amento%20para%20minha%20empresa" className="text-2xl font-bold text-blue-800 flex items-center gap-2 hover:underline">
                    ...
                    <div className="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
                        <form action="#" className="space-y-4">
                            <div>
                                ...
                                <input className="w-full rounded-lg border-gray-200 p-3 text-sm" placeholder="Nome" type="text" id="name"/>
                            </div>
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input className="w-full rounded-lg border-gray-200 p-3 text-sm" placeholder="Telefone" type="tel" id="phone"/>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea className="w-full rounded-lg border-gray-200 p-3 text-sm" placeholder="Mensagem" id="message"></textarea>
                            </div>
                            <div className="mt-4">
